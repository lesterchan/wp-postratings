...
class WP_PostRatings_Logs_Table extends WP_List_Table {
	...
	public function prepare_items() {
		...
		// phpcs:disable WordPress.DB.PreparedSQL.NotPrepared -- $count_sql is built above from bound %d/%s placeholders and a literal table name; the table is the plugin's own and the count changes on every vote.
		...
		// phpcs:disable WordPress.DB.PreparedSQL.NotPrepared -- $sql is built above from bound placeholders; $orderby/$order come from the allow list, never the request; and the table is the plugin's own.
	...
	protected function extra_tablenav( $which ) {
		...
		// The filter lists are read fresh on purpose: caching them would leave a
		// username out of the dropdown until the cache happened to expire.
